# Notes for etm
**Last modified: Wed Sep 05, 2018 12:53PM EDT**

# TOC
<!-- vim-markdown-toc GFM -->

* [Qt/QML](#qtqml)
    * [Main/View Window](#mainview-window)
        * [Menus](#menus)
* [Design](#design)
...
* [ToDo](#todo)
    * [Issues](#issues)
    * [Refactor](#refactor)
    * [Defaults/Extractions](#defaultsextractions)
    * [Completions](#completions)
    * [Jobs](#jobs)
    * [First Run](#first-run)
    * [sort and color codes](#sort-and-color-codes)
    * [Busy](#busy)
    * [alerts](#alerts)
    * [Data Migration](#data-migration)
    * [Refactor Views](#refactor-views)
* [Saved](#saved)
* [TODO](#todo-1)
    * [States](#states)
    * [Display Patterns](#display-patterns)
        * [@keys with fuzzy parsing such as @s](#keys-with-fuzzy-parsing-such-as-s)
        * [@keys with & parts such as @r](#keys-with--parts-such-as-r)
* [Defaults](#defaults)
