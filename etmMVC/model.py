...
def parse_datetime(s):
    ...
    >>> dt[1].tzinfo
    <TimezoneInfo [US/Pacific, PDT, -7:00:00, DST]>
    """
    parts = s.split(", ")
    if len(parts) < 2:
        tz = None
...
if __name__ == '__main__':
    ...
    db.insert({'pendulum list': [pendulum.Pendulum(2017, 9, 7, 12, 0, 0), pendulum.Pendulum(2017, 9, 7, 12, 0, 0, tzinfo='UTC'), pendulum.Pendulum(2017, 9, 7, 12, 0, 0, tzinfo='US/Pacific')]})
    # Absent tzinfo, the first item will be interpreted as noon UTC and will display as 8am Eastern. Ditto for the second where UTC is given explicitly. The third will be interpreted as noon Pacific and will display as 3pm Eastern.
