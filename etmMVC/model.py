...
if __name__ == '__main__':
    ...
    db.insert({'eastern pendulum': pendulum.Pendulum(2017, 9, 7, 12, 0, 0, tzinfo=gettz('US/Eastern')) })
    db.insert({'local dt': pendulum.Pendulum(2017, 9, 7, 12, 0, 0, tzinfo=tzlocal()) })
