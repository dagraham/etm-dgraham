...
- The `@s` entry is required and is interpreted as the datetime at which the action was *finished*. Note that this is a timestamp and is thus an aware datetime.
