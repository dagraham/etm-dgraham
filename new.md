...
- Tasks and jobs are displayed using `x` for finished. Unfinished tasks and jobs with no unfinished prerequisties aredisplayed using `-`. Jobs with unfinished prerequisites are displayed using `+`.
