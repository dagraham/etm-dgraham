...
- Finished tasks and jobs are displayed using `x`. Unfinished tasks and jobs with no unfinished prerequisties are displayed using `-`. Jobs with unfinished prerequisites are displayed using `+`.
